...
export default function ReactivatePremium() {
    ...
    <>
      <ScrollView contentContainerStyle={styles.getPremiumWrapper}>
        <View style={styles.copyWrapper}>
          ...
          <Text style={styles.getPremiumText}>Reactivate Sumi Premium?</Text>
          <Text style={styles.getPremiumText}>
            Your Sumi premium is due to cancel but you can reactivate it now to
            avoid losing access to members-only features.
          </Text>
          <ReactivateButton />
